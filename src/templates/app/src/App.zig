//! Root source file that implements a Mach application.
...
pub fn tick(app: *App, core: *mach.Core) void {
    ...
    // Begin render pass
    const sky_blue_background = mach.gpu.Color{ .r = 0.776, .g = 0.988, .b = 1, .a = 1 };
    ...
    const render_pass = encoder.beginRenderPass(&mach.gpu.RenderPassDescriptor.init(.{
        .label = label,
    ...
    window.queue.submit(&[_]*mach.gpu.CommandBuffer{command});
}
